...
const Contact = () => {
  ...
  <h2 className="text-[36px] font-extrabold text-center text-slate-100">Contact Me</h2>

  <article className="flex flex-col items-center gap-8 p-10 border border-gray-300 rounded-3xl shadow-xl bg-gradient-to-br  to-gray-100 hover:shadow-2xl transition-all duration-500">
